-- ============================================================================
-- Calcu-Buddy baseline migration
--
-- Creates the agreed application schema on a fresh Supabase project and safely
-- adopts a project that already ran supabase/schema.sql. It is additive and
-- idempotent: application tables and their data are never dropped or truncated.
--
